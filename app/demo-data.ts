...
export const demoSuites: DemoSuite[] = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        outputDetail: "",
        attacks: [
          a("gradinv", "GradViT 人脸梯度反演", "优化虚拟人脸，使其产生与共享梯度一致的更新信号。", "从 Face-Transformer 梯度恢复 MS-Celeb-1M 的 112×112 人脸图像。", "原生分辨率", "112×112", 90, "已有实测"),
  ...
  },
  {
    ...
    code: "DEMO 02",
    name: "城市公共服务平台",
    description: "围绕虚构居民与城市设施，比较真假查询、资格核验、拥堵等级与政策问答。",
    products: [
      {
        id: "city-existence",
        category: "030101",
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        family: "模型",
        name: "人脸图片二分类模型",
        tagline: "输入一张人脸图像，固定分类模型返回男性或女性标签。",
        template: "model",
        inputLabel: "待预测图片",
